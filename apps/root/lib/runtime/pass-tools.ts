import {
  ...
  selectResultProposedArgumentsSchema,
...
type PassToolRole = "collection" | "selection" | "record" | "write";
...
>(config: {
  ...
  role: PassToolRole;
  entityType?: "customer" | "product" | "case";
  ...
  return {
    ...
    acceptsSelection: config.acceptsSelection,
...
export const PASS_READ_TOOLS = {
  ...
  [namespacedToolName("shop", "open_product_by_id")]: definePassTool({
    providerId: "shop", tool: "open_product_by_id", readOnly: true, role: "record", entityType: "product",
    inputSchema: openProductByIdProposedArgumentsSchema, outputSchema: openProductOutputSchema, proposedSchema: proposedProductOpenByIdStepSchema,
    evidence: (data) => `Opened ${data.product.name}`,
  }),
  [namespacedToolName("shop", "select_result")]: definePassTool({
    providerId: "shop", tool: "select_result", readOnly: true, role: "selection", entityType: "product",
    inputSchema: selectResultProposedArgumentsSchema,
    outputSchema: selectResultOutputSchema,
    proposedSchema: proposedProductSelectStepSchema,
    evidence: (data) => `Selected ${data.selected.displayName}`,
  }),
  ...
  [namespacedToolName("accounts", "open_customer_by_id")]: definePassTool({
    providerId: "accounts", tool: "open_customer_by_id", readOnly: true, role: "record", entityType: "customer",
    inputSchema: openCustomerByIdProposedArgumentsSchema, outputSchema: openCustomerOutputSchema, proposedSchema: proposedCustomerOpenByIdStepSchema,
    evidence: (data) => `Opened ${data.customer.name}`,
  }),
  [namespacedToolName("accounts", "select_result")]: definePassTool({
    providerId: "accounts", tool: "select_result", readOnly: true, role: "selection", entityType: "customer",
    inputSchema: selectResultProposedArgumentsSchema,
    outputSchema: selectResultOutputSchema,
    proposedSchema: proposedCustomerSelectStepSchema,
    evidence: (data) => `Selected ${data.selected.displayName}`,
  }),
  ...
  [namespacedToolName("support", "open_case_by_id")]: definePassTool({
    providerId: "support", tool: "open_case_by_id", readOnly: true, role: "record", entityType: "case",
    inputSchema: openCaseByIdProposedArgumentsSchema, outputSchema: openCaseOutputSchema, proposedSchema: proposedCaseOpenByIdStepSchema,
    evidence: (data) => `Opened ${data.case.title}`,
  }),
  [namespacedToolName("support", "select_result")]: definePassTool({
    providerId: "support", tool: "select_result", readOnly: true, role: "selection", entityType: "case",
    inputSchema: selectResultProposedArgumentsSchema,
    outputSchema: selectResultOutputSchema,
    proposedSchema: proposedCaseSelectStepSchema,
    evidence: (data) => `Selected ${data.selected.displayName}`,
  }),
