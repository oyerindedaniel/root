...
- **Workflow:** Prepare freezes an allowlisted read graph. Execute remounts, rediscovers, and invokes each step on that document. Do not add a per-app prepare function.
